...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function update_plots(){var t=$("#plots > tbody");t.empty();var o=!0,e=!1,n=void 0;try{for(var r,a=function(){var o=r.value,e=$("<tr></tr>").appendTo(t);$("<td></td>").appendTo(e).append($("<a></a>").text(""!=o.comment?o.comment:"<no comment>").attr("href","./plot.html?"+o.id)),$("<td></td>").appendTo(e).attr("class","col-md-1").append($("<button></button>").text("Delete").attr("type","button").attr("class","btn btn-danger").on("click",function(){return monitor.plots.remove(o).then(update_plots)}))},l=monitor.plots[Symbol.iterator]();!(o=(r=l.next()).done);o=!0)a()}catch(t){e=!0,n=t}finally{try{!o&&l.return&&l.return()}finally{if(e)throw n}}}function update_logs(){var t=$("#logs > tbody");t.empty();var o=!0,e=!1,n=void 0;try{for(var r,a=function(){var o=r.value,e=$("<tr></tr>").appendTo(t);$("<td></td>").appendTo(e).text(o.path),$("<td></td>").appendTo(e).text(o.comment),$("<td></td>").appendTo(e).attr("class","col-md-1").append($("<button></button>").text("Delete").attr("type","button").attr("class","btn btn-danger").on("click",function(){return monitor.logs.remove(o).then(update_logs)}))},l=monitor.logs[Symbol.iterator]();!(o=(r=l.next()).done);o=!0)a()}catch(t){e=!0,n=t}finally{try{!o&&l.return&&l.return()}finally{if(e)throw n}}}function add_plot(){var t=$("#comment");monitor.plots.add({comment:t.val()}).then(function(){update_plots(),t.val("")})}require("babel-polyfill");var _api=require("api"),_api2=_interopRequireDefault(_api),monitor=new _api2.default("./api");$(document).ready(function(){monitor.plots.sync().then(update_plots),monitor.logs.sync().then(update_logs)});
