...
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _asyncToGenerator(t){return function(){var e=t.apply(this,arguments);return new Promise(function(t,r){function o(a,n){try{var i=e[a](n),l=i.value}catch(t){return void r(t)}if(!i.done)return Promise.resolve(l).then(function(t){o("next",t)},function(t){o("throw",t)});t(l)}return o("next")})}}function update_series(){for(var t=[0,1],e=0;e<t.length;e++){var r=t[e],o=$("#series-"+r+" > tbody");o.empty();var a=!0,n=!1,i=void 0;try{for(var l,c=function(){var t=l.value;if(t.yaxis!=r)return"continue";var e=$("<tr></tr>").appendTo(o);$("<td></td>").appendTo(e).append($("<input></input>").attr("type","color").attr("class","legend-color").attr("value",(0,_color.int2hex)(t.color)).on("change",function(){t.modify({color:(0,_color.hex2int)($(this).val())}).then(update_series)})),$("<td></td>").appendTo(e).attr("width","70%").text(t.log.comment+": "+t.key),$("<td></td>").appendTo(e).append($("<button></button>").text("Delete").attr("type","button").attr("class","btn btn-danger btn-sm pull-right").on("click",function(){return plot.series.remove(t).then(update_series)}))},d=plot.series[Symbol.iterator]();!(a=(l=d.next()).done);a=!0){c()}}catch(t){n=!0,i=t}finally{try{!a&&d.return&&d.return()}finally{if(n)throw i}}}var s=new Set,u=!0,p=!1,y=void 0;try{for(var v,f=plot.series[Symbol.iterator]();!(u=(v=f.next()).done);u=!0){var h=v.value;s.add(h.color)}}catch(t){p=!0,y=t}finally{try{!u&&f.return&&f.return()}finally{if(p)throw y}}if(s.has((0,_color.hex2int)(dialog.color.val()))){var g=Math.floor(Math.random()*(1<<24)),m=!0,x=!1,b=void 0;try{for(var _,k=colors[Symbol.iterator]();!(m=(_=k.next()).done);m=!0){var w=_.value;if(!s.has(w)){g=w;break}}}catch(t){x=!0,b=t}finally{try{!m&&k.return&&k.return()}finally{if(x)throw b}}dialog.color.val((0,_color.int2hex)(g))}update_chart()}function update_chart(){for(var t=$("input[name=xunit]:checked").val(),e=$("input[name=npoint]:checked").val(),r=["linear","linear"],o=[0,1],a=0;a<o.length;a++){var n=o[a];$("#use-logscale-"+n).is(":checked")&&(r[n]="logarithmic"),chart&&chart.options.scales.yAxes[n].type!=r[n]&&(chart.destroy(),chart=null)}var i=0,l=[],c=!0,d=!1,s=void 0;try{for(var u,p=plot.series[Symbol.iterator]();!(c=(u=p.next()).done);c=!0){var y=u.value;if(y.log.content){var v=[],f=!0,h=!1,g=void 0;try{for(var m,x=y.log.content[Symbol.iterator]();!(f=(m=x.next()).done);f=!0){var b=m.value;y.key in b&&v.push({x:b[t],y:b[y.key]})}}catch(t){h=!0,g=t}finally{try{!f&&x.return&&x.return()}finally{if(h)throw g}}i=Math.max(i,v[v.length-1].x);var _=1;""!=e&&v.length>e&&(_=v.length/e);for(var k=[],w=0;w<v.length;w+=_)k.push(v[Math.floor(w)]);l.push({label:y.log.comment,data:k,borderColor:(0,_color.int2rgb)(y.color),yAxisID:"y"+y.yaxis,pointDot:!1,fill:!1})}}}catch(t){d=!0,s=t}finally{try{!c&&p.return&&p.return()}finally{if(d)throw s}}chart||(chart=new Chart($("#plot"),{type:"line",data:{datasets:l},options:{elements:{line:{tension:0}},scales:{xAxes:[{type:"linear",position:"bottom"}],yAxes:[{id:"y0",type:r[0],position:"left"},{id:"y1",type:r[1],position:"right",gridLines:{drawOnChartArea:!1}}]},legend:{display:!1},animation:!1}})),chart.data.datasets=l,chart.options.scales.xAxes[0].ticks.min=0,chart.options.scales.xAxes[0].ticks.max=i,chart.update()}function update_dialog_open(t){dialog.log.prop("disabled",!0),dialog.key.prop("disabled",!0),dialog.yaxis.val([t]),dialog.button.prop("disabled",!0),monitor.logs.sync().then(function(){dialog.log.empty(),$("<option></option>").appendTo(dialog.log);var t=!0,e=!1,r=void 0;try{for(var o,a=monitor.logs[Symbol.iterator]();!(t=(o=a.next()).done);t=!0){var n=o.value;$("<option></option>").appendTo(dialog.log).attr("value",n.id).text(n.comment)}}catch(t){e=!0,r=t}finally{try{!t&&a.return&&a.return()}finally{if(e)throw r}}dialog.log.prop("disabled",!1)})}function update_dialog_log(t){dialog.key.prop("disabled",!0),dialog.button.prop("disabled",!0);var e=dialog.log.val();if(e){var r=monitor.logs.get(e);r.sync().then(function(){var t=new Set,e=!0,o=!1,a=void 0;try{for(var n,i=r.content[Symbol.iterator]();!(e=(n=i.next()).done);e=!0){var l=n.value,c=!0,d=!1,s=void 0;try{for(var u,p=Object.keys(l)[Symbol.iterator]();!(c=(u=p.next()).done);c=!0){var y=u.value;t.add(y)}}catch(t){d=!0,s=t}finally{try{!c&&p.return&&p.return()}finally{if(d)throw s}}}}catch(t){o=!0,a=t}finally{try{!e&&i.return&&i.return()}finally{if(o)throw a}}dialog.key.empty();var v=!0,f=!1,h=void 0;try{for(var g,m=t[Symbol.iterator]();!(v=(g=m.next()).done);v=!0){var x=g.value;"iteration"!=x&&"epoch"!=x&&$("<option></option>").appendTo(dialog.key).attr("value",x).text(x)}}catch(t){f=!0,h=t}finally{try{!v&&m.return&&m.return()}finally{if(f)throw h}}dialog.key.prop("disabled",!1)})}}function update_dialog_key(){dialog.button.prop("disabled",!1)}function add_series(){var t={log:$("#dialog-log").val(),key:$("#dialog-key").val(),color:(0,_color.hex2int)($("#dialog-color").val()),yaxis:$("input[name=dialog-yaxis]:checked").val()};plot.series.add(t).then(update_series)}function set_timer(){$("#auto-update").prop("checked")?timer||(timer=setInterval(sync_logs,5e3)):(clearInterval(timer),timer=null)}var sync_logs=function(){var t=_asyncToGenerator(regeneratorRuntime.mark(function t(){var e,r,o,a,n,i,l;return regeneratorRuntime.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:for(e=[],r=!0,o=!1,a=void 0,t.prev=4,n=plot.series[Symbol.iterator]();!(r=(i=n.next()).done);r=!0)l=i.value,e.push(l.log.sync());t.next=12;break;case 8:t.prev=8,t.t0=t.catch(4),o=!0,a=t.t0;case 12:t.prev=12,t.prev=13,!r&&n.return&&n.return();case 15:if(t.prev=15,!o){t.next=18;break}throw a;case 18:return t.finish(15);case 19:return t.finish(12);case 20:return t.next=22,Promise.all(e);case 22:update_chart();case 23:case"end":return t.stop()}},t,this,[[4,8,12,20],[13,,15,19]])}));return function(){return t.apply(this,arguments)}}();require("babel-polyfill");var _api=require("api"),_api2=_interopRequireDefault(_api),_color=require("color"),monitor=new _api2.default("./api"),plot=monitor.plots.get(location.search.slice(1)),colors=[16711680,65280,255,8421376,32896,8388736],chart=null,timer=null,dialog=void 0;$(document).ready(function(){dialog={log:$("#dialog-log"),key:$("#dialog-key"),color:$("#dialog-color"),yaxis:$("input[name=dialog-yaxis]"),button:$("#dialog-button")},plot.sync().then(function(){update_series(),sync_logs()}),set_timer()});
