...
"use strict";function int2rgb(n){return"rgb("+(n>>16&255)+","+(n>>8&255)+","+(n>>0&255)+")"}function hex2int(n){return"#"==n[0]&&(n=n.slice(1)),parseInt(n,16)}function int2hex(n){return"#"+("000000"+(n=parseInt(n).toString(16))).slice(-6)}var colors=[16711680,65280,255,8421376,32896,8388736];

},{}],331:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function update_series(){for(var t=[0,1],o=0;o<t.length;o++){var e=t[o],r=$("#series-"+e+" > tbody");r.empty();var a=!0,l=!1,i=void 0;try{for(var n,d=function(){var t=n.value;if(t.yaxis!=e)return"continue";var o=$("<tr></tr>").appendTo(r);$("<td></td>").appendTo(o).append($("<input></input>").attr("type","color").attr("class","legend-color").attr("value",(0,_color.int2hex)(t.color)).on("change",function(){t.modify({color:(0,_color.hex2int)($(this).val())}).then(update_series)})),$("<td></td>").appendTo(o).attr("width","70%").text(t.log.comment+": "+t.key),$("<td></td>").appendTo(o).append($("<button></button>").text("Delete").attr("type","button").attr("class","btn btn-danger btn-sm pull-right").on("click",function(){return plot.series.remove(t).then(update_series)}))},c=plot.series[Symbol.iterator]();!(a=(n=c.next()).done);a=!0){d()}}catch(t){l=!0,i=t}finally{try{!a&&c.return&&c.return()}finally{if(l)throw i}}}var s=new Set,p=!0,u=!1,y=void 0;try{for(var v,h=plot.series[Symbol.iterator]();!(p=(v=h.next()).done);p=!0){var f=v.value;s.add(f.color)}}catch(t){u=!0,y=t}finally{try{!p&&h.return&&h.return()}finally{if(u)throw y}}if(s.has((0,_color.hex2int)(dialog.color.val()))){var g=Math.floor(Math.random()*(1<<24)),m=!0,x=!1,b=void 0;try{for(var _,k=_color.colors[Symbol.iterator]();!(m=(_=k.next()).done);m=!0){var w=_.value;if(!s.has(w)){g=w;break}}}catch(t){x=!0,b=t}finally{try{!m&&k.return&&k.return()}finally{if(x)throw b}}dialog.color.val((0,_color.int2hex)(g))}update_chart()}function update_chart(){for(var t=$("input[name=xunit]:checked").val(),o=$("input[name=npoint]:checked").val(),e=["linear","linear"],r=[0,1],a=0;a<r.length;a++){var l=r[a];$("#use-logscale-"+l).is(":checked")&&(e[l]="logarithmic"),chart&&chart.options.scales.yAxes[l].type!=e[l]&&(chart.destroy(),chart=null)}var i=0,n=[],d=!0,c=!1,s=void 0;try{for(var p,u=plot.series[Symbol.iterator]();!(d=(p=u.next()).done);d=!0){var y=p.value;if(y.log.content){var v=[],h=!0,f=!1,g=void 0;try{for(var m,x=y.log.content[Symbol.iterator]();!(h=(m=x.next()).done);h=!0){var b=m.value;y.key in b&&v.push({x:b[t],y:b[y.key]})}}catch(t){f=!0,g=t}finally{try{!h&&x.return&&x.return()}finally{if(f)throw g}}i=Math.max(i,v[v.length-1].x);var _=1;""!=o&&v.length>o&&(_=v.length/o);for(var k=[],w=0;w<v.length;w+=_)k.push(v[Math.floor(w)]);n.push({label:y.log.comment,data:k,borderColor:(0,_color.int2rgb)(y.color),yAxisID:"y"+y.yaxis,pointDot:!1,fill:!1})}}}catch(t){c=!0,s=t}finally{try{!d&&u.return&&u.return()}finally{if(c)throw s}}chart||(chart=new Chart($("#plot"),{type:"line",data:{datasets:n},options:{elements:{line:{tension:0}},scales:{xAxes:[{type:"linear",position:"bottom"}],yAxes:[{id:"y0",type:e[0],position:"left"},{id:"y1",type:e[1],position:"right",gridLines:{drawOnChartArea:!1}}]},legend:{display:!1},animation:!1}})),chart.data.datasets=n,chart.options.scales.xAxes[0].ticks.min=0,chart.options.scales.xAxes[0].ticks.max=i,chart.update()}function update_dialog_open(t){dialog.log.prop("disabled",!0),dialog.key.prop("disabled",!0),dialog.yaxis.val([t]),dialog.button.prop("disabled",!0),monitor.logs.sync().then(function(){dialog.log.empty(),$("<option></option>").appendTo(dialog.log);var t=!0,o=!1,e=void 0;try{for(var r,a=monitor.logs[Symbol.iterator]();!(t=(r=a.next()).done);t=!0){var l=r.value;$("<option></option>").appendTo(dialog.log).attr("value",l.id).text(l.comment)}}catch(t){o=!0,e=t}finally{try{!t&&a.return&&a.return()}finally{if(o)throw e}}dialog.log.prop("disabled",!1)})}function update_dialog_log(t){dialog.key.prop("disabled",!0),dialog.button.prop("disabled",!0);var o=dialog.log.val();if(o){var e=monitor.logs.get(o);e.sync().then(function(){var t=new Set,o=!0,r=!1,a=void 0;try{for(var l,i=e.content[Symbol.iterator]();!(o=(l=i.next()).done);o=!0){var n=l.value,d=!0,c=!1,s=void 0;try{for(var p,u=Object.keys(n)[Symbol.iterator]();!(d=(p=u.next()).done);d=!0){var y=p.value;t.add(y)}}catch(t){c=!0,s=t}finally{try{!d&&u.return&&u.return()}finally{if(c)throw s}}}}catch(t){r=!0,a=t}finally{try{!o&&i.return&&i.return()}finally{if(r)throw a}}dialog.key.empty();var v=!0,h=!1,f=void 0;try{for(var g,m=t[Symbol.iterator]();!(v=(g=m.next()).done);v=!0){var x=g.value;"iteration"!=x&&"epoch"!=x&&$("<option></option>").appendTo(dialog.key).attr("value",x).text(x)}}catch(t){h=!0,f=t}finally{try{!v&&m.return&&m.return()}finally{if(h)throw f}}dialog.key.prop("disabled",!1)})}}function update_dialog_key(){dialog.button.prop("disabled",!1)}function add_series(){var t={log:$("#dialog-log").val(),key:$("#dialog-key").val(),color:(0,_color.hex2int)($("#dialog-color").val()),yaxis:$("input[name=dialog-yaxis]:checked").val()};plot.series.add(t).then(update_series)}async function sync_logs(){var t=[],o=!0,e=!1,r=void 0;try{for(var a,l=plot.series[Symbol.iterator]();!(o=(a=l.next()).done);o=!0){var i=a.value;t.push(i.log.sync())}}catch(t){e=!0,r=t}finally{try{!o&&l.return&&l.return()}finally{if(e)throw r}}await Promise.all(t),update_chart()}function set_timer(){$("#auto-update").prop("checked")?timer||(timer=setInterval(sync_logs,5e3)):(clearInterval(timer),timer=null)}require("babel-polyfill");var _api=require("api"),_api2=_interopRequireDefault(_api),_color=require("color"),monitor=new _api2.default("./api"),plot=monitor.plots.get(location.search.slice(1)),chart=null,timer=null,dialog=void 0;$(document).ready(function(){dialog={log:$("#dialog-log"),key:$("#dialog-key"),color:$("#dialog-color"),yaxis:$("input[name=dialog-yaxis]"),button:$("#dialog-button")},plot.sync().then(function(){update_series(),sync_logs()}),set_timer()});
