...
function update_series() {
    ...
    if (used_colors.has((0, _color.hex2int)(dialog.color.val()))) {
        ...
        try {
            for (var _iterator2 = _color.colors[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                var c = _step2.value;
...
function update_dialog_log(yaxis) {
    ...
    log.sync().then(function () {
        ...
        try {
            for (var _iterator7 = log.content[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                ...
                try {
                    for (var _iterator9 = Object.keys(entry)[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
...
async function sync_logs() {
    ...
    try {
        for (var _iterator10 = plot.series[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
            var _series3 = _step10.value;

            promises.push(_series3.log.sync());
        }
    } catch (err) {
